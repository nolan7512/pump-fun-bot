...
# Trading parameters
BUY_AMOUNT = 0.05  # Amount of SOL to spend when buying
BUY_SLIPPAGE = 0.5  # 20% slippage tolerance for buying
SELL_SLIPPAGE = 0.5  # 20% slippage tolerance for selling

# Your nodes
# You can also get a trader node https://docs.chainstack.com/docs/solana-trader-nodes
RPC_ENDPOINT = "https://solana-mainnet.core.chainstack.com/867775ea93322a69e273234646b95d03"
